 ...
 * </p>
 * <ul>
 *   <li>{@link de.senacor.smt.model.smtmetamodel.impl.DocumentImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.senacor.smt.model.smtmetamodel.impl.DocumentImpl#getEntites <em>Entites</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DocumentImpl extends MinimalEObjectImpl.Container implements Document {
	...
	protected EClass eStaticClass() {
		return SmtmetamodelPackage.Literals.DOCUMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmtmetamodelPackage.DOCUMENT__NAME, oldName, name));
	}
	...
	public EList<Entity> getEntites() {
		if (entites == null) {
			entites = new EObjectContainmentWithInverseEList<Entity>(Entity.class, this, SmtmetamodelPackage.DOCUMENT__ENTITES, SmtmetamodelPackage.ENTITY__DOCUMENT);
		}
		return entites;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SmtmetamodelPackage.DOCUMENT__ENTITES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SmtmetamodelPackage.DOCUMENT__NAME:
				return getName();
			case SmtmetamodelPackage.DOCUMENT__ENTITES:
				return getEntites();
		}
