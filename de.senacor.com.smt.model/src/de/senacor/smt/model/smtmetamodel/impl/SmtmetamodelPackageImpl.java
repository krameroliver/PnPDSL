 ...
 * @generated
 */
public class SmtmetamodelPackageImpl extends EPackageImpl implements SmtmetamodelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see de.senacor.smt.model.smtmetamodel.SmtmetamodelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private SmtmetamodelPackageImpl() {
		super(eNS_URI, SmtmetamodelFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link SmtmetamodelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static SmtmetamodelPackage init() {
		if (isInited) return (SmtmetamodelPackage)EPackage.Registry.INSTANCE.getEPackage(SmtmetamodelPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredSmtmetamodelPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		SmtmetamodelPackageImpl theSmtmetamodelPackage = registeredSmtmetamodelPackage instanceof SmtmetamodelPackageImpl ? (SmtmetamodelPackageImpl)registeredSmtmetamodelPackage : new SmtmetamodelPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theSmtmetamodelPackage.createPackageContents();

		// Initialize created meta-data
		theSmtmetamodelPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theSmtmetamodelPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(SmtmetamodelPackage.eNS_URI, theSmtmetamodelPackage);
		return theSmtmetamodelPackage;
	}
	 ...
	 */
	@Override
	public EReference getDocument_Entites() {
	 ...
	 */
	@Override
	public EReference getEntity_Document() {
	 ...
	 */
	@Override
	public EAttribute getField_Preciscion() {
	 ...
	 */
	@Override
	public SmtmetamodelFactory getSmtmetamodelFactory() {
		return (SmtmetamodelFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(documentEClass, DOCUMENT__ENTITES);
	...
	public void initializePackageContents() {
		...
		initEReference(getDocument_Entites(), this.getEntity(), this.getEntity_Document(), "entites", null, 0, -1, Document.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(dataTypeEEnum, DataType.NOT_SET);
