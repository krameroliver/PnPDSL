...
/**
 * This is the item provider adapter for a {@link de.senacor.smt.model.smtmetamodel.Includes} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IncludesItemProvider 
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Includes"));
	}
	...
	public String getText(Object object) {
		String label = ((Includes)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Includes_type") :
			getString("_UI_Includes_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Includes.class)) {
